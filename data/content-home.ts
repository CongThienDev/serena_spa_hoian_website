...
export function getHomeCopy(locale: Locale) {
  if (locale === "vi") {
    return {
      ...
      features: {
        sectionAria: "Trụ cột wellness",
        items: [
          { title: "Wellness toàn diện", description: "Cân bằng thân - tâm - trí qua các liệu pháp cổ truyền kết hợp hiện đại." },
      ...
      treatments: {
        ...
        bookingEyebrow: "Đặt lịch wellness",
      ...
      blog: {
        eyebrow: "Nhật ký wellness",
        title: "Từ Serena Journal",
      ...
      cta: {
        ...
        title: "Bắt đầu hành trình wellness ngay hôm nay",
