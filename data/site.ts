...
export const NAV_ITEMS: NavItem[] = [
  { label: "About", href: "/about" },
  {
    ...
    children: [
      ...
      { label: "Relaxation", href: "/services?category=relaxation" },
      { label: "Body Treatment", href: "/services?category=body-treatment" },
      { label: "SPA - Face Treatment", href: "/services?category=face-treatment" },
      { label: "SPA - Body Care Treatment", href: "/services?category=body-care-treatment" },
      { label: "Serena Signature", href: "/services?category=serena-signature" },
      { label: "SPA Package", href: "/services?category=spa-package" },
  ...
  },
  {
    ...
    href: "/wellness",
    children: [
      { label: "Wellness Overview", href: "/wellness" },
      { label: "Wellness Philosophy", href: "/wellness#philosophy" },
      { label: "The Serena Method", href: "/wellness#method" },
    ],
  },
